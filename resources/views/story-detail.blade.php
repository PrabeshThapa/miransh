    ...
    <section class="detail-hero">
        <div class="container">
            ...
            <div style="font-size: 14px; color: #CBD5E1; margin-top: 8px;">
                <span>{{ $story->published_date ?? '2024.11.20' }}</span> | <span>{{ $story->author ?? 'MIRANSH Editorial Team' }}</span>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="detail-content-layout">
                <div class="detail-main-content">
                    <img src="{{ $story->image ?? '/images/story1.jpg' }}" alt="{{ $story->title_ja }}" class="detail-banner-img">
                    ...
                    <div class="detail-prose">
                        <div class="lang-ja" style="white-space: pre-line;">
                            {{ $story->content_ja ?? $story->summary_ja }}
                        </div>
                        <div class="lang-en" style="white-space: pre-line;">
                            {{ $story->content_en ?? $story->summary_en }}
                        </div>
                    </div>
                </div>
                        ...
                        <div style="margin-top: 36px; border-top: 1px solid var(--border-color); padding-top: 24px;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 12px;">
                                @foreach ($allStories as $s)
                                    @if ($s->id !== $story->id)
                                    <a href="/stories/{{ $s->id }}" style="font-size: 13px; color: #2563EB; font-weight: 600; line-height: 1.4;">
                                        <span class="lang-ja">• {{ $s->title_ja }}</span>
