        ...
        <div class="login-card">
            ...
            <form action="<?php echo e(route('admin.login.submit')); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="email" name="email" class="form-control" required placeholder="admin@miransh.jp" value="<?php echo e(old('email', 'admin@miransh.jp')); ?>" autofocus>
                </div>
            ...
            <a href="<?php echo e(route('home')); ?>" class="back-link">← Return to Website</a>
        </div>
    </div>
</body>
</html>
