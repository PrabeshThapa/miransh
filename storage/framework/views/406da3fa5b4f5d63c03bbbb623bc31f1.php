            ...
            <div class="services-grid">
                ...
                <div class="service-card">
                    <div class="service-card-header">
                        <span class="service-num-badge"><?php echo e($service->number_label ?? '01'); ?></span>
                        <div class="service-icon-box">
                            <?php if($service->icon === 'users'): ?>
                            ...
                            <?php elseif($service->icon === 'heart-handshake'): ?>
                    ...
                    <div class="service-card-body">
                        ...
                        <?php if($service->subtitle_ja || $service->subtitle_en): ?>
                        <div class="service-subtitle">
                            <span class="lang-ja"><?php echo e($service->subtitle_ja); ?></span>
                            <span class="lang-en"><?php echo e($service->subtitle_en); ?></span>
                        </div>
                        <?php endif; ?>

                        <p class="service-desc">
                            <span class="lang-ja"><?php echo e($service->desc_ja); ?></span>
                            <span class="lang-en"><?php echo e($service->desc_en); ?></span>
                        </p>
                        ...
                        <div class="service-card-footer">
                            <a href="/services/<?php echo e($service->id); ?>" class="btn-service-detail">
            ...
            <div class="stories-grid">
                ...
                <div class="story-card">
                    ...
                    <div class="story-card-body">
                        ...
                        <a href="/stories/<?php echo e($story->id); ?>" class="story-read-link">
                    ...
                    <table class="profile-table">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <strong><span class="lang-ja"><?php echo e($company->name_ja ?? 'MIRANSH合同会社（ミランス合同会社）'); ?></span></strong>
                                    <br>
                                    <span class="lang-en" style="color: var(--text-light);"><?php echo e($company->name_en ?? 'MIRANSH LLC (MIRANSH Godo Kaisha)'); ?></span>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="vision-card">
                <div class="vision-grid">
                    <div class="vision-ceo-card">
                        <img src="<?php echo e($company->ceo_image ?? '/images/abc.jpeg'); ?>" alt="<?php echo e($company->ceo_name); ?>" class="vision-ceo-photo">
                        <h3 class="vision-ceo-name"><?php echo e($company->ceo_name ?? 'ギリ ラム クリシュナ'); ?></h3>
                        ...
                        <div class="vision-signature-block">
                            <div>
                                ...
                                <div class="vision-sign-name">
                                    <span class="lang-ja"><?php echo e($company->ceo_role_ja ?? '代表社員'); ?> <?php echo e($company->ceo_name ?? 'ギリ ラム クリシュナ'); ?></span>
                                    <span class="lang-en"><?php echo e($company->ceo_name ?? 'Giri Ram Krishna'); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
